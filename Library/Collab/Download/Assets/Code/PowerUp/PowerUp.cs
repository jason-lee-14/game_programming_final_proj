...
public class PowerUp : MonoBehaviour
{
    ...
    IEnumerator Pickup(Collider player, int ability)
    {
        ...
        PowerupManagement powerupStats = GameObject.Find("Map").GetComponent<PowerupManagement>();
        powerupStats.currPowerups--;
        ...
        if (ability == 0)
        {
            ...
            playerMovement.speed = playerMovement.speed * speedMultiplier;
        ...
        if (ability == 2)
        {
            ...
            ThirdPersonMovement playerMovement = player.GetComponent<ThirdPersonMovement>();
            if (playerMovement.jumpSpeed != playerMovement.speed * jumpSpeedMultiplier)
            {
                playerMovement.jumpSpeed = playerMovement.jumpSpeed * jumpSpeedMultiplier;
            }
        }
        ...
        // Take the power away
        ThirdPersonMovement resetPlayer = player.GetComponent<ThirdPersonMovement>();
        if (ability == 0)
        {
            /*resetPlayer.speed /= speedMultiplier;*/
            resetPlayer.speed = 5;
        }
        if (ability == 2)
        {
            /*resetPlayer.jumpSpeed /= jumpSpeedMultiplier;*/
            resetPlayer.jumpSpeed = 8;
        }
